...
Usage:
    ...
    if ready:
        console.print("\n[bold green]🟢 Overall Status: Ready for operation[/bold green]")
    else:
        console.print("\n[bold red]🔴 Overall Status: Setup required[/bold red]")
        console.print("🔵 Run '[bold cyan]python pepelugpt.py setup[/bold cyan]' to initialize the system")   python pepelugpt.py chat         # Start interactive chat
...
def chat(
    ...
    try:
        ...
        try:
            ...
            console.print("🔵 Initializing Interface...", style="cyan")
            
            # Create and run chat interface
            chat_interface = ChatInterface()
            if not chat_interface.load_database():
                console.print("🔴 Database loading failed. Run setup first.", style="red")
                raise typer.Exit(1)
            ...
            console.print("🔴 Chat interface unavailable. Please check installation.", style="red")
            raise typer.Exit(1)
    except Exception as e:
...
def main():
    ...
    try:
        ...
        console.print("🔵 Check your system configuration.")
